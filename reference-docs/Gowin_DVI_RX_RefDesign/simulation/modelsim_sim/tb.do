...
vlog -novopt ../../project/src/dvi_rx/dvi_rx.vo
#vlog -novopt  \
#+incdir+../../project/src/dvi_rx/ \
#../../project/src/dvi_rx/*.v
...
add wave -noupdate -radix hexadecimal /tb/pll_phase     
add wave -noupdate                    /tb/pll_phase_lock
